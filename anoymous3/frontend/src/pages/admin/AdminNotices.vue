<template>
  <section class="admin-page">
    <h2>관리자 · 공지 관리</h2>
    <p class="muted">공지 목록/등록/수정/삭제를 여기서 처리할 예정입니다. (임시 스텁)</p>
    <router-link class="btn" to="/admin">← 대시보드로</router-link>
  </section>
</template>
...
<style scoped>
.admin-page{max-width:960px;margin:24px auto;padding:0 16px}
